...
class doubleFMdemod_TCP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "doubleFMdemod_TCP")
...
def main(top_block_cls=doubleFMdemod_TCP, options=None):
