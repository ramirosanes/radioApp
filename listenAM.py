...
class listenAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "listenAM")
        ...
        self.taps_sca = taps_sca = firdes.low_pass(2, 1920000, 10000,40000, window.WIN_KAISER, 6.76)
        ...
        self._station2_range = qtgui.Range(-480e3, 360e3, 40e3, 0, 200)
        ...
        self.top_layout.addWidget(self._station2_win)
        self._station1_range = qtgui.Range(-480e3, 360e3, 40e3, 0, 200)
        ...
        self.top_layout.addWidget(self._station1_win)
        ...
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(2, taps_sca, station2, samp_rate)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(2, taps_sca, station1, samp_rate)
        ...
        self.analog_agc2_xx_0_0 = analog.agc2_cc((625e-6), (10e-6), 1.0, 1.0, 65536)
        self.analog_agc2_xx_0 = analog.agc2_cc((625e-6), (10e-6), 1.0, 1.0, 65536)
        ...
        self.connect((self.analog_agc2_xx_0_0, 0), (self.rational_resampler_xxx_0_0, 0))
    ...
    def set_station2(self, station2):
        ...
        self.freq_xlating_fir_filter_xxx_0_0.set_center_freq(self.station2)
    ...
    def set_station1(self, station1):
        ...
        self.set_filename(self.rootdir+self.record_file_path+"_"+"Station1:"+str(int(self.centerFreq+self.station1-125e6))+"Hz_""Station2:"+str(int(self.centerFreq+self.station2-125e6))+"Hz_"+str(int(self.samp_rate))+"sps_")
        self.freq_xlating_fir_filter_xxx_0.set_center_freq(self.station1)
...
def main(top_block_cls=listenAM, options=None):
